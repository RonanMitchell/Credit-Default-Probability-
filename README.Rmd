...
```{r Ridges,  warning =  FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r Demographics,  warning =  FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r Box Plots,  warning =  FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r Variables for Exclusion,  warning =  FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r warning =  FALSE, out.height="80%", out.width="80%", fig.align='center'}
