...
The purpose of this README is to provide a basic machine learning procedure, from receiving the data to prediction, of a Random Forest model, K-Nearest-Neighbors (KNN) and a LASSO regression. These are compared to a standard statistical/econometric logit model. The Random Forest model predicts whether a person will default on a loan with about 89% accuracy. 
