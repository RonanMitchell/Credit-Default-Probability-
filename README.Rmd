...
```{r Ridges,  warning =  FALSE, out.height="100%", out.width= "100%"}
...
```{r Demographics,  warning =  FALSE, out.height="100%", out.width= "100%"}
...
```{r Box Plots,  warning =  FALSE, out.height="100%", out.width= "100%"}
...
```{r Variables for Exclusion,  warning =  FALSE , out.height="100%", out.width= "100%"}
